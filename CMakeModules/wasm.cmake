...
macro(add_wast_executable)
  ...
  add_custom_command(OUTPUT ${DESTINATION_FOLDER}/${target}.wast
    DEPENDS ${target}.s
    COMMAND ${S2WASM_PATH} -o ${DESTINATION_FOLDER}/${target}.wast -s 10240
          ${MAX_MEMORY_PARAM} ${target}.s
  ...
  add_custom_command(OUTPUT ${DESTINATION_FOLDER}/${target}.wasm
    DEPENDS ${target}.wast
    COMMAND ${WAST2WASM_PATH} ${DESTINATION_FOLDER}/${target}.wast
          ${DESTINATION_FOLDER}/${target}.wasm -n
